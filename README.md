...
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
| 프린터 이름  | 플러스 200  | 오버클론 223 블랙| MA3D:Standard | 코어200 | LUGO_M | CUBICON Single Plus |
...
| 챔버형 | O | X | 분체도장 철판+투명PC판 2중구조 | 풀메탈 | O | O |
| 챔버 필터 |  | X | X |  |  | O |
| 조립 판매| X | X | X | 반조립 |  | X |
| 완제품 판매 | O | O | O |  |  | O |
...
| 출력 속도 |  | < 200 mm/s | < 200 mm/s |  | < 300 mm/s | < 500 mm/s |
| SMPS | 12V 350W | 12V 250W| 24V 350W + 150W Dual Power |  |  | 24V 25A |
| 마더보드 | RAMPS 1.4 | RAMPS 1.4 | MKS Gen v1.4 |
| 드라이버 | TMC-2208 | A4988 | XY(TMC2208) ZE(A4988)
| 히팅 베드 | 알루미늄 히팅베드() | MK2B | MK2A 알루미늄 히팅베드 | MK2B |
| 베드 타입 |  | 아노다이징 베드 | 울트라베이스 탄소코팅 유리
| 구동 방식 |  | MENDEL | H-Bot | CORE XY |
| 축 방식 |  |  | XYZ(MGN12H) | XY(연마봉)
| Z축 이동 |  |  | TM 스크류 | TM 스크류 |
| 오토 레벨링 |  | Inductive Sensor | 정품 BL Touch |
| 필라멘트 센서 |  |  | 옵션 |  |  | O |
| 필라멘트 | PLA, ABS, TPU | PLA, ABS | PLA ABS PETG PC | PLA, ABS, Flexible | PLA, ABS, PC | ABS, PLA, TPU |
| 디스플레이 |  |  | MKS TFT32 터치스크린 한글 UI 적용 |
| 노즐 개수 | Single | Single | Single | Single | Single |
| 핫엔드 |  |  | 티타늄 노즐목 + 볼케이노 핫앤드 |  |  |  |
| 익스트루더 | MK8 보우덴 |  | 기어드 익스트루더 | 자체개발 |
| SD 카드 | O |  | O | O |  |  |
| USB 연결 | O |  | O | O | O | O |
| WIFI |  |  | 옵션 |  |  | O |
| 자체 슬라이서 | X | X | X | X | X | O |
| 펌웨어 | Marlin 1.8 |  | Marlin 1.8 |  |
| Custom 펌웨어 | 허용 |  |  |  |
| 오픈소스 | O |  |  |  |
| A/S 비용 | 무상수리 6개월 |  | 1년간 A/S 공임 무료, 제품 크기가 커 배송이 어려운 관계로 자가수리 고려 |  |
